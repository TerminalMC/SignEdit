...
import dev.terminalmc.signtweaks.command.Commands;
...
@Mod(
        value = SignTweaks.MOD_ID,
        dist = Dist.CLIENT
)
@EventBusSubscriber(
        modid = SignTweaks.MOD_ID,
        value = Dist.CLIENT
)
public class SignTweaksNeoForge {

    public SignTweaksNeoForge() {
    ...
    static void registerKeyMappings(RegisterKeyMappingsEvent event) {
        SignTweaks.KEYBINDS.forEach(event::register);
    }
    ...
    static class ClientEventHandler {
        ...
        public static void registerAfterClientTick(ClientTickEvent.Post event) {
            SignTweaks.afterClientTick(Minecraft.getInstance());
        }
    }
}
